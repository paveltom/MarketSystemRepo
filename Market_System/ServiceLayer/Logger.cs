    ...
    public class Logger
    {
        ...
        private Logger()
        {
            ...
            else //Meaning that we're running the tests.
            {
                log_event_path = "";
                log_errors_path = "";
                tests_log_events_path = "";
                tests_log_errors_path = "";


                this.regular_log_events_path = "";
                this.regular_log_errors_path = "";
                this.tests_log_events_path = "";
                this.tests_log_errors_path = "";
